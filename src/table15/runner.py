...
def run(configs_path='../configs/pima_diabetes.yaml'):
    ...
    df_logits_out = plutils.visualize_output(baseline_to_scores_df, baselines, features, output='logits')
    df_probs_out = plutils.visualize_output(baseline_to_scores_df, baselines, features, output='probs')
